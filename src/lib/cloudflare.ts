...
export const CLOUDFLARE_R2_WEBSITE_ASSETS_URL = 'https://web-asset.terusmengajar.id';
// export const CLOUDFLARE_R2_PRODUCTS_MAIN_STORAGE_URL = 'https://pub-098c9d7bf3d5466b86f0f0725eb42439.r2.dev';
export const CLOUDFLARE_R2_PRODUCTS_MAIN_STORAGE_URL = 'https://asset.terusmengajar.id';

export const CLOUDFLARE_D1_SEO_URL = `https://api.cloudflare.com/client/v4/accounts/${process.env.CLOUDFLARE_ACCOUNT_ID}/d1/database/${process.env.CLOUDFLARE_DATABASE_SEO_ID}/query`;