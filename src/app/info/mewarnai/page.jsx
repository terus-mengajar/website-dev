...
export default function page() {
  ...
  return (
    <main className="text-gray-800">
      ...
      <section className="pt-28 pb-12 px-8 bg-[#FBF6F2] relative overflow-hidden">
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row gap-4 md:gap-16 items-center">
            <div className="">
              <Image
                src="/images/assets/mewarnai.png"
                width={400}
                height={400}
                alt="Calistung"
      ...
      <section className="py-20 px-4 bg-[url(/images/home/rekomendasi/bg-mewarnai.png)] bg-cover bg-no-repeat bg-center  min-h-[200px] md:min-h-[280px] flex flex-col justify-center">
        <div className="container">
          <h2 className="text-coklat text-xl md:text-2xl font-bold text-center mb-8 max-w-2xl mx-auto">
            Temukan berbagai aktivitas mewarnai di Funpaper Harian
          </h2>

          <div className="flex justify-center">
            <Link href={`/funpaper-harian?aktivitas=${MEWARNAI}`} className="tombol-coklat">
              Coba Sekarang
            </Link>
          </div>
        </div>
