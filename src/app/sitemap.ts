...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const funpaperHarianPages: MetadataRoute.Sitemap = funpaperHarianItems.map((item: { slug: string; updated_at?: string }) => ({
  ...
  const funpaperTemaPages: MetadataRoute.Sitemap = funpaperTemaItems.map((item: { slug: string; updated_at?: string }) => ({
  ...
  const funpaperCalistungPages: MetadataRoute.Sitemap = funpaperCalistungItems.map((item: { slug: string; updated_at?: string }) => ({
  ...
  const miniGamePages: MetadataRoute.Sitemap = miniGameItems.map((item: { slug: string; updated_at?: string }) => ({
